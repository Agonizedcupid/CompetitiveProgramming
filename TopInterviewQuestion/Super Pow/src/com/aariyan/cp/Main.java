...
public class Main {
    ...
    public static int superPow(int a, int[] b) {
        ...
        int numbers = 0;
        for (int i : b) {
            numbers = (numbers * 10 + i) % 1140;
        }
        if (a == 1) return 1;
        return calculateSuperPower(a, numbers);
    }

    public static int calculateSuperPower(int a, long power) {
        if (power == 0) {
            return 1;
        } else if (power % 2 == 0) { // Even condition
            int breakDownIntoSmallPieces = calculateSuperPower(a, power / 2);
            return (breakDownIntoSmallPieces * breakDownIntoSmallPieces) % 1337;
        } else { //Odd condition
            return ((a % 1337) * calculateSuperPower(a, power - 1)) % 1337;
        }
    }
}
